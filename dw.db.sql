...
CREATE TABLE [ksjianli](
  ...
  [GanBuJiBie] NVARCHAR(200) NOT NULL DEFAULT '');
...
CREATE TABLE [kslist](
  ...
  [NianLing] INTEGER NOT NULL DEFAULT 0, 
  [XiuGaiShiJian] NVARCHAR(1000) NOT NULL DEFAULT '', 
  [ChuangJianShiJian] NVARCHAR(100) NOT NULL DEFAULT '', 
  [DanWeiMingCheng] NVARCHAR(200) NOT NULL DEFAULT '', 
  [BuMenMingCheng] NVARCHAR(200) NOT NULL DEFAULT '', 
  [ZhiWuLeiBie] NVARCHAR(100) NOT NULL DEFAULT '', 
  [GanBuJiBie] NVARCHAR(200) NOT NULL DEFAULT '', 
  [JiShuZhiWuJiBie] NVARCHAR(200) NOT NULL DEFAULT '', 
  [JiaoShouXueKe] NVARCHAR(200) NOT NULL DEFAULT '', 
  [ZhuYaoBuZu] NVARCHAR(200) NOT NULL DEFAULT '', 
  [TeDianShanChang] NVARCHAR(200) NOT NULL DEFAULT '', 
  [DangPaiMingCheng] NVARCHAR(100) NOT NULL DEFAULT '', 
  [GaiGeTuiXiuShiJian] NVARCHAR(100) NOT NULL DEFAULT '', 
  [GaiGeTuiXiuNianLing] INTEGER NOT NULL DEFAULT 0, 
  [GaiGeTuiXiuNianYue] NVARCHAR(100) NOT NULL DEFAULT '', 
  [BanZiFenGong] NVARCHAR(2000) NOT NULL DEFAULT '', 
  [LianXiFangShi] NVARCHAR(200) NOT NULL DEFAULT '', 
  [DanWeiNeiXuhao] INTEGER NOT NULL DEFAULT 0, 
  [DanWeiPaiXuId] INTEGER NOT NULL DEFAULT 0, 
  [ShiFouJiBing] NVARCHAR(1000) NOT NULL DEFAULT '', 
  [RenXianZhiShiJian] NVARCHAR(100) NOT NULL DEFAULT '', 
  [RenTongZhiJiShiJian] NVARCHAR(100) NOT NULL DEFAULT '', 
  [RenYuanShuXing] NVARCHAR(1000) NOT NULL DEFAULT '', 
  [BiaoQian] NVARCHAR(1000) NOT NULL DEFAULT '');

CREATE TABLE [ma_dwmc](
  [myid] INTEGER PRIMARY KEY AUTOINCREMENT UNIQUE DEFAULT 0, 
  [lb] NVARCHAR(200) DEFAULT '', 
  [mc] NVARCHAR(200) DEFAULT '');
